...
/// </summary>
public class fighterplanescript : EnemyBaseScript
{
    ...
    void Start()
    {
        ...
        barrel2 = this.transform.Find("2BarrelEnd").gameObject;
    ...
    private void Shoot()
    {
        ...
        clone2.transform.position = barrel2.transform.position;

        Vector3 playerdir2 = (playermidpoint.transform.position - barrel2.transform.position).normalized;
        clone2.transform.LookAt(playermidpoint.transform);
        clone2.transform.rotation *= Quaternion.Euler(new Vector3(0, 90, 0));
        clone2.GetComponent<Rigidbody>().AddForce(playerdir2 * 1500);
    ...
    private void StraightShot()
    {
       ...
       clone.GetComponent<Rigidbody>().AddForce(-this.transform.forward * 1500);
        ...
        clone2.GetComponent<Rigidbody>().AddForce(-this.transform.forward * 1500);
    }
